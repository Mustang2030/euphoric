                ...
                Column(
                  ...
                  children: [
                    ...
                    StyledFormField(
                      ...
                      readonly: true,
                      validator: validDate,
                      decoration: formS("Date Of Birth", "", Icons.date_range),
                      onPressed: () {
                        _selectDate();
                      },
                    ),
                      ...
                      if (_formKey.currentState!.validate()) {
                        ...
                        if (_auth?.displayName != null) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                  "Hello ${_auth!.displayName}. You have successfuly registered as an Admin"),
                            ),
                          );
                        } else {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text(
                                  "You have successfuly registered as an Admin"),
                            ),
                          );
                        }
                        Navigator.push(
  ...
  Future register() async {
    {
      ...
      FirebaseFirestore.instance
          ...
          .set(
        {
          ...
          "Date Of Birth": _dOBController.toString(),
